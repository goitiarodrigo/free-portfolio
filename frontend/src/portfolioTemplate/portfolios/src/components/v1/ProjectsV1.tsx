    ...
    return (
        <div id='projects' className={styles.container}>
            ...
            <div className={arrProjects.length % 2 === 0 ? styles.projects_containerV1 : styles.projects_containerV2}>
                    ...
                    {arrProjects.length % 2 !== 0 ? <div className={styles.title_container}><h1 style={{fontSize: '3.5rem'}}>Proyectoss</h1></div> :
                        <div className={styles.isImpar_container} >
                            ...
                            <div className={`${styles.title_containerV1}`}><h1 style={{fontSize: '3.5rem'}}>Proyectos</h1></div>
                        </div>
                    }
                ...
                {arrProjects.map((project, index) => {
                    ...
                    <>
                        <div className={styles.last_container}>
                            <div className={styles.title_container}><span style={{fontSize: '2.3rem', fontWeight: 'bold'}}>Pronto habrá mas...</span></div> 
                            <div style={{backgroundImage: `url(${image})`}} className={styles.project_image_isImpar}>
                                <div className={styles.description_container}>
                                    <h2>{name}</h2>
                                    <p>{description}</p>
                    ...
                    :
                    <div className={`${styles.title_containerV2}`}><span style={{fontSize: '2.3rem', fontWeight: 'bold'}}>Pronto habrá mas...</span></div>
                    }
